...
SECRET_KEY = 'django-insecure-9ksn8^l9+y+f57msx(uo4pk9@i-#!m5!^b)pgo9s-e5&n5-kwm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'backendcoach.onrender.com',
    'localhost',
    '127.0.0.1'
]
...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.c5w8ukwgqz6r.eu-north-1.rds.amazonaws.com',  
        'PORT': '3306', 
    }
}
